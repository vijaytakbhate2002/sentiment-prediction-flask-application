    ...
    def readLast(self):
        ...
        try:
            ...
            if last_row:
                ...
                formatted_row = f"ID: {last_row[0]}, User Input: {last_row[1]}, Prediction: {last_row[2]}, " \
                                f"User Satisfaction Level: {last_row[3]}, Suggestions: {last_row[4]}"
